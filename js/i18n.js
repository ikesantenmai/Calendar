...
(function (global) {
  ...
  var DICT = {
    ja: {
      ...
      'cal.exportShare': '共有して書き出す',
      'cal.exportShareNote': 'ダウンロードで保存できないときに使います（「ファイルに保存」など）',
      ...
      'msg.exported': '{n} 件を .ics でダウンロードしました',
      'msg.exportShared': '保存先を選んでください（「ファイルに保存」でファイル App に保存できます）',
    ...
    en: {
      ...
      'cal.add': 'Add',
      'cal.lang': '言語 / Language',
      'cal.exportShare': 'Export via the share sheet',
      'cal.exportShareNote': 'Use this when the download cannot be saved (“Save to Files” and so on)',
      ...
      'msg.exported': 'Downloaded {n} events as .ics',
      'msg.exportShared': 'Choose where to keep it — “Save to Files” stores it in the Files app',
